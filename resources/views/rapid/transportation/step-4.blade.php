                     ...
                     <div class="Content">
                        <div class="">
                           <div class="contentDiv">
                                 ...
                                 @endif
                                  ...
                                  @endif  
                                    <div class="prev-step-label" style="display: inline-block; width: 100%;">
                                       ...
                                       @if('physical' == $decisionTree->component_type)
                                       Step 3A: Modulation of risks by the project`s soft components
                                       @else
                              ...
                              @endif
                              <p class="step_desc">In this step you will consider the level of risk to the outcome/service delivery that your project is aiming to provide.</p>
                                       ...
                                       <div class="dt_rating_container">
                                          ...
                                          <div class="dt_rating_right">
                                             <div class="form-type-textarea form-item-dt-step4-notes form-item form-group">
                                                ...
                                                <div class="form-textarea-wrapper"><textarea class="form-control form-textarea" id="edit-dt-step4-notes" name="outcome_notes" cols="9" rows="7" placeholder="Sample Text: The project will prioritize rehabilitation of road infrastructure. This will be based on the probability and impact of failure, both in terms of population impacted and socio economic infrastructure, including structural risk and economic costs. The high potential risk to the road infrastructure due to increased extreme precipitation and flooding is greatly reduced by the design standards of the project and the development of emergency systems. Therefore, the overall risk to the outcome of the project is considered to be Moderate.">{{ $decisionTree->outcome_notes }}</textarea>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
