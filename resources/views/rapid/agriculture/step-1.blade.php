         ...
         <div class="Content">
            <div class="">
               <div class="contentDiv">
                  <p class="step_desc">Agriculture sector projects can be exposed to several climate geophysical hazards. For instance, extreme temperatures can affect agricultural and livestock productivity, while extreme precipitation can affect soil erosion, agricultural production, rural roads and crop storage and processing. Click here for more examples 
                  ...
                  <div class="tooltip_templates" style="display: none;">
                     ...
                     <span id="step1-info-icon">
                        <ul>
                           <li><strong>High temperatures</strong> can affect agricultural and livestock productivity </li>
                           <li><strong>Extreme precipitation and flooding</strong> can affect soil erosion, agricultural production, rural roads, and crop storage and processing</li>
                           <li><strong>Drought</strong> can dramatically affect crop yields and livestock productivity</li>
                           <li><strong>Sea level rise and storm surge</strong> can cause coastal flooding that inundates land and damages rural infrastructure</li>
                           <li><strong>Strong winds</strong> such as earthquakes, tsunamis, volcanic eruptions, and landslides can cause physical damage to water infrastructure</li>
                           <li><strong>Geophysical hazards </strong> such as earthquakes, tsunamis, volcanic eruptions, and landslides can affect agriculture production and the delivery of agricultural services</li>
                        </ul>
                     </span>
