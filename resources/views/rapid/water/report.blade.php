                              ...
                              <div class="sec-process-note-impact-body">
                                 ...
                                 <div style="font-size: 20px;margin-top: 10px;color: #404040;">
                                    ...
                                    <ul  style="padding-left: 19px;margin: 0;margin-top: 5px;">
                                        ...
                                        <li>Does the project design consider how the structural integrity, materials, siting, longevity and overall effectiveness of health infrastructure, if applicable, may be impacted?</li>
                  ...
                  <div class="sec-guidance" style="font-size: 12px;">
                     ...
                     <div class="sec-guidance-body">
                        ...
                        <div class="sec-guidance-body-cont3" style="margin-top: 20px;">
                           <div style="color: #222222!important;text-align:center; font-size: 19px; padding-bottom: 5px; padding-top: 5px;font-family: 'Roboto-Medium' !important;"><b>Table 2: Types of Climate Risk Management Measures for Typical Water Projects</b></div>
                           <div class="sec-guidance-body-cont3body">
                                <table width="100%" border="1" style="page-break-inside:auto !important;">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td width="20%" style="font-size: 19px; color: #454545;">Increase water availability </td>
                                            <td width="80%" style="font-size: 19px; color: #454545;">
                                                <ul>
                                                <li>Develop redundant services to increase water capture and storage options, including rainwater harvesting and storage</li>
                                                <li>Explore natural resource management approaches to increase storage in the watershed or break waves, such as establishment of mangroves</li>
                                                <li>Develop new sources of water including reclaimed water</li>
                                                <li>Integrate infrastructure for multiple uses at the household level to improve resilience to decreased rainfall from climate change and variability</li>
                                                <li>Improve water-use efficiency by recycling water</li>
                                                <li>Develop water conservation programs</li>
                                                <li>Expand use of economic incentives including metering and pricing to encourage water conservation</li>
                                                <li>Expand use of water markets to reallocate water to highly valued uses</li>
                                                </ul>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="20%" style="font-size: 19px; color: #454545;">Secure water quality </td>
                                            <td width="80%" style="font-size: 19px; color: #454545;">
                                                <ul>
                                                <li>Develop a source water protection strategy/plan that accounts for the impacts of low flow on the ability of natural systems to dilute and absorb pollutants</li>
                                                <li>Investigate land use and waste management policies to improve source water quality</li>
                                                <li>Develop a coastal aquifer protection strategy</li>
                                                <li>Evaluate treatment options to improve water quality</li>
                                                </ul>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td width="80%" style="font-size: 19px; color: #454545;">
                                                ...
                                                <li>Design food risk-management plans with both ecosystem- and construction-based adaptation options</li>
                                                </ul>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td width="80%" style="font-size: 19px; color: #454545;">
                                                ...
                                                <li>Improve distribution system infrastructure</li>
                                                <li>Update zoning codes for coastal land to establish natural buffer zones</li>
                                                </ul>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td width="80%" style="font-size: 19px; color: #454545;">
                                                <ul>
                                                <li>Evaluate improving, elevating, or moving treatment facilities to prevent overflows and inundation</li>
                                        ...
                                        <tr>
                                            ...
                                            <td width="80%" style="font-size: 19px; color: #454545;">
                                                ...
                                                <li>Build relevant national and/or regional research programs on the links between climate and water supply and sanitation (e.g. vulnerability index)</li>
                                                </ul>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td width="80%" style="font-size: 19px; color: #454545;">
                                                ...
                                                <li>Foster integrated resource management with agriculture and energy</li>
                                                <li>Improve finance for water systems that are more adaptive and better designed for a changing climate, including through private sector investment and incentives; ensure consideration of climate risk in financing approaches</li>
                                                <li>Strengthen disaster planning and response for water infrastructure and water services</li>
                                                <li>Improve training, education and outreach efforts and programs related to watershed protection, water demand, water sanitation, and other factors relevant to water-related climate impacts and adaptation</li>
                                                </ul>
                                            </td>
                                        </tr>
                                    </tbody>
                                ...
                                <div style="width: 100%; text-align: center;margin-top: 20px;">
                                    <p style="font-size: 19px; color: #454545;">Sources: <a href="https://www.climatelinks.org/sites/default/files/2017-03-14 USAID CRM Tool Water Supply and Sanitation Annex.pdf" style="color: #217fca;">USAID Climate Risk Screening and Management Tools: Water Supply and Sanitation Annex;</a>  <a href="https://docs.google.com/a/ccrdproject.com/viewer?a=v&amp;pid=sites&amp;srcid=Y2NyZHByb2plY3QuY29tfGNjcmR8Z3g6NmYyZDYxZDdiZTQwZmI0NA" style="color: #217fca;">USAID Addressing Climate Impacts on Infrastructure;</a> <a href="http://www.ipcc.ch/pdf/technical-papers/climate-change-water-en.pdf" style="color: #217fca;">IPCC Technical Paper on Climate Change and Water</a></p>
                                </div>
                           </div>
                        </div>
                     </div>
