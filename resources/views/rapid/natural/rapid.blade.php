                  ...
                  <div class="sp_head">
                     ...
                     <div style="display:none;">
                        <span id="Exposure-info1-2">
                            <ul>
                                <li>Consider your project’s natural resource-related infrastructure and other physical assets as currently designed.</li>
                  ...
                  <div class="sp_head">
                     ...
                     <div style="display:none;">
                        <span id="Exposure-info1-3b-new">
                            <ul>
                                <li>Your project is taking place within a broader development context, which includes the natural resources sector and other social, economic and political factors.</li>
                  ...
                  <div class="sp_head">
                     ...
                     <div style="display:none;">
                        <ul id="Exposure-info2-2">
                            <li>Your project is taking place within a broader development context, which includes the naturalresources sector and other social, economic and political factors.  </li>
                            <li>How does this context modulate the risks from climate and geophysical hazards on your project? </li>
                        </ul>
                     </div>
                  </div>
