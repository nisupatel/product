						...
						<div class="tree-box-inner">
							...
							<div class="tree-box-rate">
									...
									<div class="dtsteps_rate_box">
										<div class="dtsteps_rate_box_colors" style="text-align: center; background-color:{{ $colors[$projectData->rapid->exposure_rating] }}"> {{ $colors_text[$projectData->rapid->exposure_rating] }}</div>
					...
					<div class="tree-box secondary-box">
							<div class="tree-box-inner">
										...
										<div class="sp_head">
											...
											<div style="display:none;">
													<span id="Exposure-info1-2">
														<ul>
															<li>Consider your project’s energy infrastructure and other physical assets as currently designed.</li>
								...
								<div class="tree-box-rate">
									...
									<div class="dtsteps_rate_box">
										<div class="dtsteps_rate_box_colors" style="text-align: center; background-color: {{ $colors[$projectData->rapid->impact_rating] }} ">{{ $colors_text[$projectData->rapid->impact_rating] }}</div>
											...
											<div class="sp_head">
												...
												<div style="display:none;">
														<span id="Exposure-info-3a">
															<ul>
																<li>Consider soft components that are relevant for your project (e.g. Institutional Strengthening, Training, Knowledge Exchange)</li>
											...
											<div class="sp_head">
												...
												<div style="display:none;">
														<span id="Exposure-info1-3b-new">
															<ul>
																<li>Your project is taking place within a broader development context, which includes the energy sector and other social, economic and political factors. </li>
					...
					<div class="tree-box secondary-box">
							<div class="tree-box-inner">
								...
								<div class="tree-box-rate">
										...
										<div class="dtsteps_rate_box">
											<div class="dtsteps_rate_box_colors" style="text-align: center; background-color: {{ $colors[$projectData->rapid->outcome_rating] }}">{{ $colors_text[$projectData->rapid->outcome_rating] }}</div>
					...
					<div class="tree-box-inner">
						...
						<div class="step_heading tooltip_matrix" data-tooltip-content="#Exposure-info2-2">
							<div class="sp_head">
								...
								<div style="display:none;">
									<p id="Exposure-info2-2">Your project is taking place within a broader  country context, which includes the energy sector and other social, economic and political factors. How does this context influence the climate and disaster risks for your project?</p>
								</div>
							</div>
						</div>
						<div class="tree-box-rate">
