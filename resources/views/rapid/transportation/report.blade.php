                           ...
                           <div class="sec-sr-main-body">
                              ...
                              <div class="report-summary-step1" style="background-color: #f0f0f0 !important; padding: 10px; border: 1px solid #c0c0c0;display: block; clear: both; color: #404040;">
                                 <div style="font-size:23px;padding-left: 10px;padding-top: 5px; padding-right: 10px; padding-bottom: 10px; border: 1px solid #c0c0c0;background-color: #fff;">1. Exposure of the project location: <span style="font-size: 19px;">This step assesses the current and future exposure of the project location to relevant
                                    climate and geophysical hazards as an aggregate</span></div>
                              ...
                              <div class="sec-process-note-impact" style="margin-top: 10px;">
                                 ...
                                 <div class="sec-process-note-impact-body">
                                    ...
                                    <div style="font-size: 20px;margin-top: 10px;color: #404040;">
                                       ...
                                       <ul  style="padding-left: 19px;margin: 0;margin-top: 5px;">
                                          <li>Does the project design take into account recent trends and future projected changes in identified climate and geophysical hazards?
                                            </li>
                                          <li> Does the project design consider how the structural integrity, materials, siting, longevity and overall effectiveness of transportation
                                          infrastructure, if applicable, may be impacted?</li>
                     ...
                     <div class="sec-guidance" style="font-size: 12px;">
                        ...
                        <div class="sec-guidance-body">
                           ...
                           <div class="sec-guidance-body-cont3" style="margin-top: 20px;">
                              <div style="color: #222222!important;text-align:center; font-size: 19px; padding-bottom: 5px; padding-top: 5px;font-family: 'Roboto-Medium' !important;"><b>Table 2: Types of Climate Risk Management Measures for Typical Transportation Projects</b></div>
                              <div class="sec-guidance-body-cont3body">
                                 <table width="100%" border="1" style="page-break-inside:auto !important;">
                                    <tbody>
                                        <tr>
                                         ...
                                         <tr>
                                            <td width="20%" style="font-size: 19px; color: #454545;">Changes in Operations</td>
                                            <td width="80%" style="font-size: 19px; color: #454545;">
                                               <ul>
                                                <li>Shift construction schedules to cooler parts of the day to address health and safety concerns and avoid vehicle overheating and deterioration</li>
                                                <li>Develop redundant structures or services that can be relied upon if disruptions occur</li>
                                                <li>Shorten maintenance periods to accommodate changes in precipitation and temperature</li>
                                                <li>Increase inspection frequency to ensure structures are enduring climate change pressures</li>
                                                <li>Increase financial and technical resources for more frequent maintenance and repairs</li>
                                                <li>Shortening of season for use of ice roads to reduce removal costs and environmental impacts from salt and chemical use</li>
                                                <li>Increase use of sonars to monitor stream-bed flow and bridge scour </li>
                                                <li>Integrate emergency evacuation procedures into operations </li>
                                                <li>Use bridge openings more frequently for ships in the event of severe storm surges</li>
                                                <li>Increase payload restrictions on aircraft at high-altitude or hot-weather airports</li>
                                                <li>Temporarily close airports and ports when extreme weather events occur</li>
                                               </ul>
                                            </td>
                                         </tr>
                                         <tr>
                                            <td width="20%" style="font-size: 19px; color: #454545;">Changes in Infrastructure Design and Materials</td>
                                            <td width="80%" style="font-size: 19px; color: #454545;">
                                               <ul>
                                                   <li>Develop new, heat-resistant paving materials for construction of roadways, runways, and rail tracks</li>
                                                   <li>Use improved asphalt/concrete mixtures for roads and runways</li>
                                                   <li>Increase use of heat-tolerant street and highway landscaping</li>
                                                   <li>Greater use of continuous welded rail lines to avoid rail-track deformities </li>
                                                   <li>Use insulation in road prism to reduce thawing of permafrost, which causes subsidence of roads, rail beds, bridge supports (cave-in), and pipelines</li>
                                                   <li>Elevate bridge, tunnel, and transit entrances to reduce inundation and severe flooding of low-lying infrastructure</li>
                                                   <li>Build and strengthen existing levees, seawalls, and dikes to protect high-value coastal real estate</li>
                                                   <li>Upgrade existing infrastructure drainage systems and increase standards for new transportation infrastructure and major rehabilitation projects (e.g., assuming 100-year and 500-year storms)</li>
                                                   <li>Increase pumping capacity for tunnels</li>
                                                   <li>Increase culvert capacity </li>
                                                   <li>Use flexible, expandable materials in railway systems</li>
                                                   <li>Protect critical evacuation routes</li>
                                                   <li>Protect bridge piers and abutments with riprap</li>
                                                   <li>Change bridge design to tie decks more securely to substructure and strengthen foundations </li>
                                                   <li>Adopt modular construction techniques where infrastructure is in danger of failure (such as modular traffic features and road sign systems for easier replacement)</li>
                                                   <li>Use more dredging of channels</li>
                                                   <li>Raise docks, wharf levels, jetties, and seawalls to protect harbors and terminal and warehouse entrances</li>
                                                   <li>Extend runway lengths at high-altitude or hot-weather airports</li>
                                               </ul>
                                            </td>
                                         </tr>
                                         <tr>
                                            ...
                                            <td width="80%" style="font-size: 19px; color: #454545;">
                                               <ul>
                                                   <li>Convert coastal land uses to establish natural buffer zones</li>
                                                   <li>Relocate roads, railways, and airport runways further inland</li>
                                               </ul>
                                            </td>
                                         </tr>
                                         <tr>
                                            ...
                                            <td width="80%" style="font-size: 19px; color: #454545;">
                                               <ul>
                                                   ...
                                                   <li>Build relevant national and/or regional research programs on the links between climate and transportation sector</li> 
                                                   <li>Improve the ability to forecast landfall and trajectory of hurricanes </li>
                                                   <li>Track changes in maintenance needs and schedules over time as adaptation actions are implemented</li>
                                                   <li>Monitor changing environmental conditions affected by climate (e.g., land erosion patters, frequency and severity of inundation events) to understand evolving adaptation needs</li>
                                               </ul>
                                            </td>
                                         </tr>
                                         <tr>
                                            ...
                                            <td width="80%" style="font-size: 19px; color: #454545;">
                                               <ul>
                                                <li>Identify transportation-related development goals important to the country, region , or community</li>
                                                <li>Identify inputs and enabling conditions necessary to achieving transportation-related development goals </li>
                                                <li>Integrate climate information into system planning to assess climate impacts on transportation infrastructure and understanding adaptation needs and economic implications</li>
                                                <li>Design flood risk-management plans with both ecosystem- and construction-based adaptation options</li>
                                                <li>Update design standards to elevate roadways to accommodate future sea level rise and high winds</li>
                                                <li>Consider storm surge in coastal road planning</li>
                                                ...
                                                <li>Improve finance for transportation systems that are more adaptive and better designed for a changing climate, including through private sector investment and incentives; ensure consideration of climate risk in financing approaches</li>
                                                <li>Strengthen disaster planning and response for transportation infrastructure and services</li>
                                               </ul>
                                            </td>
                                         </tr>
                                    </tbody>
                                 ...
                                 <div style="width: 100%; text-align: center;margin-top: 20px;">
                                    <p style="font-size: 19px; color: #454545;">Sources: <a href="https://www.climatelinks.org/sites/default/files/2017-03-14 USAID CRM Tool transportation Supply and Sanitation Annex.pdf" style="color: #217fca;">USAID Climate Risk Screening and Management Tools: Infrastructure, Construction and Energy; Addressing Climate Change Impacts on Infrastructure; TRS Special Report: Potential Impacts of Climate Change on Transportation </a></p>
                                 </div>
                              </div>
                           </div>
                        </div>
