<?php
    ...
    if ($rating == 5 || $rating == 4) {
        ...
        $output .= '<div><b>RESOURCES:</b><br /><ul style="padding-top: 5px;"><li>For a more guided screening of your project Use the In-Depth Screening Assessment</li><li>If you need further assistance:<ul><li>Visit the Screening Resources page of the tool for additional guidance and a list of useful resources.</li>
    ...
    elseif ($rating == 1) {
        $output .= '<div class="overall-rating-text">';
        $output .=  '<div><b>Given that you have an insufficient understanding of how to assess climate and disaster risks for your project, here are some suggested next steps:</b><br /><ul><li>Save your assessment.</li><li>Gather more information to improve your understanding of climate and geophysical hazards and their relationship to your project.</li><li>Conduct a more guided screening of your project using the In-Depth Screening Assessment.</li><li>Visit the Screening Resources page of the tool for additional guidance and a list of useful resources.</li>
        <li>Contact the Help Desk for advice and assistance on screening.</li></ul></div>';
        $output .= '</div>';
    }
?>
@extends('layouts.app')
