            ...
            <div class="dt_rating_container">
               ...
               <div class="dt_rating_right">
                  <div class="form-type-textarea form-item-dt-step4-notes form-item form-group">
                     ...
                     <div class="form-textarea-wrapper"><textarea class="form-control form-textarea" id="edit-dt-step4-notes" name="outcome_notes" cols="9" rows="7" placeholder="The project aims to provide direct protection to approximately 1 million people living within polder boundaries. It will do so by upgrading the existing embankments and drainage systems. The level of protection to be provided is intended to be enough to withstand 25-year return period storm surges for the lifetime of the project (up to year 2050).">{{ $decisionTree->outcome_notes }}</textarea>
                     </div>
                  </div>
               </div>
            </div>
