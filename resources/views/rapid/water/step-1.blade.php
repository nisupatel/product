         ...
         <div class="Content mt10">
            <div class="">
               <div class="contentDiv">
                  <p class="step_desc">
                  Water sector projects can be exposed to several climate geophysical hazards. For instance, extreme temperatures can affect water resources, treatment, and demand, while extreme precipitation can affect the quality and continuity of water, wastewater, and sanitation services. Click here for more examples
                  ...
                  <div class="tooltip_templates" style="display: none;">
                     ...
                     <span id="step1-info-icon">
                        <ul>
                          <li><strong>Extreme temperatures</strong> can affect water resources, treatment, and demand </li>
                          <li><strong>Extreme precipitation and flooding</strong> can affect the quality and continuity of water, wastewater, and sanitation services</li>
                          <li><strong>Drought</strong> can affect the quantity and quality of water supply</li>
                          <li><strong>Sea level rise, storm surge and high winds</strong> can damage water supply, treatment facilities and distribution networks</li>
                          <li><strong>Strong winds</strong> can damage soil quality and existing vegetation</li>
                          <li><strong>Geophysical hazards</strong> such as earthquakes, tsunamis, volcanic eruptions, and landslides can cause physical damage to water infrastructure</li>
                        </ul>
                     </span>
