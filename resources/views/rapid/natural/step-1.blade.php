         ...
         <div class="Content">
            <div class="">
               <div class="contentDiv">
                  <p class="step_desc">Natural resources sector projects can be exposed to several climate geophysical hazards. Changing climatic conditions can cause ecological disturbances that affect the health of ecosystems including aquatic and forest ecosystems. Click here for more examples.
                     ...
                     <div>
                        <div class="step1_ques1">
                           ...
                           <div class="hazard-suffix">
                              You may also visit:
                              <ul>
                                 <li><a href="http://thinkhazard.org/" target="_blank">ThinkHazard!</a> for more detailed information on cyclones, river and coastal floods, water scarcity, and geophysical hazards.</li>
                              </ul>
                           </div>
                        </div>
                                 ...
                                 <div class="form-type-textarea form-item-dt-step1-notes form-item form-group">
                                    ...
                                    <div class="form-textarea-wrapper">
                                       <textarea class="form-control form-textarea" id="edit-dt-step1-notes" name="exposure_notes" cols="9" rows="7" 
                                          placeholder="Sample text. The highest monthly average maximum daily temperature is 33°C. The number of ‘hot days’ per year, defined as the upper end of the range of maximum temperature values, has increased by 25 days in the last 40 years. Annual average temperature is expected to increase by 1°C to 2.8°C by 2060 relative to current conditions and the number of hot days in the month of October is expected to increase by approximately 10 days by 2060. At the same time, mean monthly rainfall has decreased in recent decades. However, the proportion of rainfall falling in heavy events has increased at an average rate of 2.6%, and the 5-day annual rainfall maxima have increased by 8.4 mm per decade, with the largest increases in the wet season. The proportion of rain that falls in heavy events is projected to increase in the coming decades by approximately 15%. Wet season (Dec – Feb) rainfall is also projected to increase, and the wet season may become longer. In terms of sea level rise, similar projects have occasionally been inundated during extreme high tides. Local sea level rise is 4 mm/year. Given the relatively long project lifetime, this rate is likely to increase significantly in the coming decades. Because of the projected increases in extreme temperature and precipitation as well as sea level rise, the rating is Highly Exposed.">{{$decisionTree->exposure_notes}}</textarea>
                                    </div>
                                 </div>
                              </div>
                           </div>
                  ...
                  <div class="tooltip_templates" style="display: none;">
                     ...
                     <strong>Insufficient:</strong> There is insufficient knowledge about the project or insufficient understanding of how to interpret information on climate and geophysical hazards to make a rating.
                     </span>
                     <span id="step1-info-icon">
                        <ul>
                              <li><b>Changes in temperature and precipitation</b> can increase wildfires or windstorms that can destroy or degrade forest ecosystems and associated ecosystem services.</li>
                              <li><b>Changes in temperature and precipitation</b> can also increase the spread of invasive species and pathogens, which affect the distribution, composition, and health of ecosystems. </li>
                              <li><b>Extreme temperatures</b> can affect the health of coastal ecosystems, populations and their livelihoods, as well as the operation of coastal infrastructure and ecosystem defenses.</li>
                              <li><b>Heavy rainfall and riverine flooding</b> can over-saturate soil along the coast, eliminating natural drainage and worsening coastal flooding.</li>
                              <li><b>Sea level rise and storm surge</b> can destroy coastal ecosystems, such as mangroves and salt marshes on which many fish and shellfish species depend.</li>
                        </ul>
                     </span>
