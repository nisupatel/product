										...
										<div class="sp_head">
											...
											<div style="display:none;">
												<span id="Exposure-info1-2">
													<ul>
														<li>Consider your project’s water infrastructure and other physical assets as currently designed.</li>
											...
											<div class="sp_head">
												...
												<div style="display:none;">
													<span id="Exposure-info1-3b-new">
														<ul>
															<li>Your project is taking place within a broader development context, which includes the water sector and other social, economic and political factors. </li>
					...
					<div class="tree-box-inner">
						...
						<div class="step_heading tooltip_matrix" data-tooltip-content="#Exposure-info2-2">
							<div class="sp_head">
								...
								<div style="display:none;">
									<p id="Exposure-info2-2">Your project is taking place within a broader  country context, which includes the water sector and other social, economic and political factors. How does this context influence the climate and disaster risks for your project?</p>
								</div>
							</div>
						</div>
						<div class="tree-box-rate">
